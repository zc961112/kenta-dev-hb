...
const whiteList = ['/', '/index', '/login', '/loginbypass', '/password', '/privacy-policy', '/recover-password', '/terms-conditions', '/auth', '/custom-trip', '/custom-trip-step1', '/about', '/blog', '/blog-article', '/casino-profile', '/contact', '/cookie-policy', '/destination', '/create', '/twitter', '/ticket', '/menu-app', '/ticket-detail', '/mobileIndexDestination', '/mobileIndexDate', '/mobileIndexGuest', '/comingSoon', '/detail', '/destination/new-york']
