...
const whiteList = [
	...
	'/ValenciaPage',
	// -----新增------ 
	'/', '/index', '/login', '/password', '/privacy-policy', '/recover-password', '/terms-conditions', '/auth',
	'/custom-trip', '/custom-trip-step1', '/about', '/blog', '/blog-article', '/casino-profile', '/contact',
	'/cookie-policy', '/destination', '/create', '/twitter', '/ticket', '/menu-app', '/ticket-detail',
	'/mobileIndexDestination', '/mobileIndexDate', '/mobileIndexGuest', '/comingSoon', '/detail',
...
export default ({
	...
	app.router.afterEach((transition) => {
		...
		if (transition.name === 'destination-id') {
			const params = transition.params
