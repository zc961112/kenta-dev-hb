  ...
  >
    <div class="select-date-con">
      ...
      <div class="tab-con" v-if="dateType == 0">
        <date-picker ref="myDatePicker" v-model="dates" type="daterange" @pick="confirmDateRange" popperClass="date-content" value-format="yyyy-MM-dd" range-separator="至" start-placeholder="" end-placeholder="" />
    ...
    <div class="date-show-inp" slot="reference">
      <div v-show="dateType==0">
        <el-input placeholder="Add dates" v-model="formDate1" @click.stop.native="handleVisible3" @clear="handleDateClear"></el-input>
