<template lang="html">
    <div class="inp-box" :style="colorChange()" >
        <i class="icon icon-search">
            <img src="~assets/images/hebrew-icon-search.png" alt="" style = "">
        </i>
        <el-popover placement="bottom-start" style="width:100%" trigger="manual" :visible-arrow="false"
            ...
            <el-input placeholder="חפשו חבילות, כרטיסים או יעדים" v-model="location.label" v-on:change="colorChange()" slot="reference" style ="font-family: Noto Sans Hebrew; font-size: 16px; font-weight: 500;line-height: 16px;"
