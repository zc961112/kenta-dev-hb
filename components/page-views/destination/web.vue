    ...
    <div class="page-area-content">
      ...
      <div class="pac-right">
        <div class="pac-right-top">
          <div class="pac-title">Select a casino hotel</div>
          <div class="pac-search">
            <el-autocomplete
              class="pac-input"
              v-model="searchQuery.destinationName"
              placeholder="Search for specific Casino"
              suffix-icon="el-icon-search"
              :fetch-suggestions="queryFetch"
              @focus="searchQuery.destinationName=''"
          ...
          <div class="pac-filters">
            <filter-datepicker
              class="pacf-dp"
              :start-and-end-time="searchQuery.date"
              :date-type="searchQuery.dateType"
        ...
        <div class="pac-list">
          ...
          <casino-box
            ...
            :casino="item"
            :parent="form"
            @enter="showMapPopper(item)"
            @leave="hideMapPopper(item)"
