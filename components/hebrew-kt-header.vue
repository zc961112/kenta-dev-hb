        ...
        <el-drawer title="" :append-to-body="true" :visible.sync="drawer" :direction="direction" :size="drawerSize"
            ...
            <div class="navigation-wrap">
                    ...
                    <el-collapse-item title="Destinations" name="1">
                        <div class="city-box">
                            <div class="item-list">
                                ...
                                <div class="item"><router-link to="../destination/las-vegas">Las Vegas</router-link></div>
                                <div class="item"><router-link to="../destination/reno">Reno</router-link></div>
                                <div class="item"><router-link to="../destination/atlantic-city">Atlantic City</router-link></div>
                            ...
                            <div class="item-list">
                                ...
                                <div class="item"><router-link to="../destination/vancouver">Vancouver</router-link></div>
                ...
                <div class="nav-list">
                    ...
                    <div class="item"><router-link to="../comingSoon">Partners <span class="will">COMING SOON</span></router-link></div>
  ...
  methods: {
    ...
    handleCommand (command) {
      ...
      if (command == 'logout') {
        ...
        this.$router.push({ path: '/userdashboard', query: { pageIndex: 0 } })
      } else if (command == 'Viewed') {
        this.$router.push({ path: '/userdashboard', query: { pageIndex: 1 } })
      } else if (command == 'Saved') {
        this.$router.push({ path: '/userdashboard', query: { pageIndex: 3 } })
...
.header {
  ...
  background: transparent; /* 设置背景完全透明 */
