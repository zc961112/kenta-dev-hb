<template lang="html">
	<div>
		<nav class="header" :style="{backgroundColor:ishome?'rgba(255, 255, 255, 0)':'rgba(255, 255, 255, 1)'}">
			<div class="logo" @click="toHome">
				<img v-if="ishome" src="~assets/images/logo-white.png" alt='logo' />
		...
		<div :style="{height:!ishome?'0.64rem':'0'}"></div>
	</div>
	<!-- header end-->
</template>
