    ...
    <div class="center">
      <div class="top">
        <div class="guide">
          ...
          <svg class="text-center" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
            <path d="M6.66666 4.66675L9.99999 8.00008L6.66666 11.3334" stroke="#1A1A1A" stroke-opacity="0.6" stroke-linecap="round" stroke-linejoin="round"/>
          </svg>
        ...
        <div class="introduction">
          ...
          <p class="text-introduction text-introduction-mobile">Please contact us for any questions that you may have by submitting your details below.</p>
        </div>
      </div>
      <div class="table animate__animated" ref="animatedBox" :class="searchValited?'':'animate__shakeX'">
        <div class="name">
          ...
          <div class="input">
            <el-input v-model="form.firstName" placeholder="First name" :class="searchValited?'':'animate__shakeX'" :style="showBorderRed(form.firstName)"></el-input>
          </div>
          <div class="input">
            <el-input v-model="form.lastName"placeholder="Last name" :class="searchValited?'':'animate__shakeX'" :style="showBorderRed(form.lastName)"></el-input>
          </div>
        </div>
        <div class="name">
          <div class="text">
          ...
          <div class="input">
            <el-input v-model="form.email" placeholder="Email address" :class="searchValited?'':'animate__shakeX'" :style="showBorderRed(form.email)"></el-input>
          </div>
          <div class="input">
            <el-input v-model="form.confirmEmail" placeholder="Confirm email address" :class="searchValited?'':'animate__shakeX'" :style="showBorderRed(form.confirmEmail)"></el-input>
          </div>
        </div>
        <div class="name">
          <div class="text">
        ...
        <div class="name">
          ...
          <div class="input-one">
            <el-input v-model="form.subject" placeholder="How can we help?" :class="searchValited?'':'animate__shakeX'" :style="showBorderRed(form.subject)"></el-input>
          </div>
        </div>
        <div class="name">
          <div class="text">
          ...
          <div class="input-two">
            <el-input v-model="form.message" class="textarea" type="textarea" placeholder="Enter booking reference if available" :class="searchValited?'':'animate__shakeX'" :style="showBorderRed(form.message)"></el-input>
          </div>
        </div>
      </div>
      <div class="bottom">
        ...
        <div class="content">
          <div class="prompt">
            <el-checkbox v-model="checked"><span class="left-text">By proceeding, you accept our&nbsp;</span></el-checkbox>
